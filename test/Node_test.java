...
public class Node_test {
    ...
    public void constructorTest() {
        ...
        Node n = new Node(list, 42, "action", "Node_test", "true", "in", "left");

        assertEquals(n.list(), list);
        assertEquals(n.id(), 42);
        assertEquals(n.kind(), "action");
        assertEquals(n.name(), "Node_test");
    ...
    public void isRequestTest(){
        Node n1 = new Node(null, 42, "action", "Node_test", "true", "" , "left");
        Node n2 = new Node(null, 42, "action", "Node_test", "true", "POST", "left");
        Node n3 = new Node(null, 42, "action", "Node_test", "true", "GET", "left");
        Node n4 = new Node(null, 42, "action", "Node_test", "true", "OTHER", "left");
    ...
    public void listConstrAndAddTest() {
        ...
        Node n1 = new Node();
        Node n2 = new Node(null, 42, "action", "Node_test", "true", "POST", "left");
        Node n3 = new Node(list, 42, "action", "Node_test", "true", "POST", "left");
    ...
    public void nameConstrAndAddTest() {
        ...
        assertEquals("Node_test", n2.name());
    }
