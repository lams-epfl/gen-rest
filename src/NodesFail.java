...
public class NodesFail extends ArrayList<Node> {
...
/**
    ...
    @SuppressWarnings("unchecked")
    Node elementData(int index) {
        return (Node) elementData[index];
    }
...
/**
    ...
    public Node set(int index, Node element) {
        ...
        Node oldValue = elementData(index);
